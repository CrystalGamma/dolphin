...
void Interpreter::ps_div(UGeckoInstruction inst)
{
  ...
  const double ps0 = NI_div(a.PS0AsDouble(), b.PS0AsDouble()).ApplyAndGetSingle(&FPSCR);
  const double ps1 = NI_div(a.PS1AsDouble(), b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_sub(UGeckoInstruction inst)
{
  ...
  const double ps0 = NI_sub(a.PS0AsDouble(), b.PS0AsDouble()).ApplyAndGetSingle(&FPSCR);
  const double ps1 = NI_sub(a.PS1AsDouble(), b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_add(UGeckoInstruction inst)
{
  ...
  const double ps0 = NI_add(a.PS0AsDouble(), b.PS0AsDouble()).ApplyAndGetSingle(&FPSCR);
  const double ps1 = NI_add(a.PS1AsDouble(), b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_mul(UGeckoInstruction inst)
{
  ...
  const double ps0 = NI_mul(a.PS0AsDouble(), c0).ApplyAndGetSingle(&FPSCR);
  const double ps1 = NI_mul(a.PS1AsDouble(), c1).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_msub(UGeckoInstruction inst)
{
  ...
  const double ps0 = NI_msub(a.PS0AsDouble(), c0, b.PS0AsDouble()).ApplyAndGetSingle(&FPSCR);
  const double ps1 = NI_msub(a.PS1AsDouble(), c1, b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_madd(UGeckoInstruction inst)
{
  ...
  const double ps0 = NI_madd(a.PS0AsDouble(), c0, b.PS0AsDouble()).ApplyAndGetSingle(&FPSCR);
  const double ps1 = NI_madd(a.PS1AsDouble(), c1, b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_nmsub(UGeckoInstruction inst)
{
  ...
  const double tmp0 = NI_msub(a.PS0AsDouble(), c0, b.PS0AsDouble()).ApplyAndGetSingle(&FPSCR);
  const double tmp1 = NI_msub(a.PS1AsDouble(), c1, b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_nmadd(UGeckoInstruction inst)
{
  ...
  const double tmp0 = NI_madd(a.PS0AsDouble(), c0, b.PS0AsDouble()).ApplyAndGetSingle(&FPSCR);
  const double tmp1 = NI_madd(a.PS1AsDouble(), c1, b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_sum0(UGeckoInstruction inst)
{
  ...
  const double ps0 = NI_add(a.PS0AsDouble(), b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_sum1(UGeckoInstruction inst)
{
  ...
  const double ps1 = NI_add(a.PS0AsDouble(), b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_muls0(UGeckoInstruction inst)
{
  ...
  const double c0 = Force25Bit(c.PS0AsDouble());
  const double ps0 = NI_mul(a.PS0AsDouble(), c0).ApplyAndGetSingle(&FPSCR);
  const double ps1 = NI_mul(a.PS1AsDouble(), c0).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_muls1(UGeckoInstruction inst)
{
  ...
  const double c1 = Force25Bit(c.PS1AsDouble());
  const double ps0 = NI_mul(a.PS0AsDouble(), c1).ApplyAndGetSingle(&FPSCR);
  const double ps1 = NI_mul(a.PS1AsDouble(), c1).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_madds0(UGeckoInstruction inst)
{
  ...
  const double c0 = Force25Bit(c.PS0AsDouble());
  const double ps0 = NI_madd(a.PS0AsDouble(), c0, b.PS0AsDouble()).ApplyAndGetSingle(&FPSCR);
  const double ps1 = NI_madd(a.PS1AsDouble(), c0, b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
...
void Interpreter::ps_madds1(UGeckoInstruction inst)
{
  ...
  const double c1 = Force25Bit(c.PS1AsDouble());
  const double ps0 = NI_madd(a.PS0AsDouble(), c1, b.PS0AsDouble()).ApplyAndGetSingle(&FPSCR);
  const double ps1 = NI_madd(a.PS1AsDouble(), c1, b.PS1AsDouble()).ApplyAndGetSingle(&FPSCR);
